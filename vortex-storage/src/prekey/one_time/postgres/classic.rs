...
#[derive(Debug, Clone)]
pub struct PgClassicKeys {
    handle: PgHandle,
}

impl PgClassicKeys {
    pub fn new(handle: PgHandle) -> PgClassicKeys {
        PgClassicKeys { handle }
    }
}

#[async_trait]
impl OneTimeKeys for PgClassicKeys {
    async fn add_many(
        &self,
        user_id: i64,
        ...
        let inserted = sqlx::query!(
            r#"
            INSERT INTO onetime_prekeys (user_id, device_id, key_id, public_key, used, created_at)
