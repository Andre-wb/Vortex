# `sol/vortexx/android/push/` — `push` feature

Android feature package for **push**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Push/`.
