# `sol/vortexx/android/feeds/` — `feeds` feature

Android feature package for **feeds**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Feeds/`.
