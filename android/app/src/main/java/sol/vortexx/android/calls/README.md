# `sol/vortexx/android/calls/` — `calls` feature

Android feature package for **calls**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Calls/`.
