# `sol/vortexx/android/rooms/` — `rooms` feature

Android feature package for **rooms**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Rooms/`.
