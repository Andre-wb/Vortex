# `sol/vortexx/android/files/` — `files` feature

Android feature package for **files**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Files/`.
