# `sol/vortexx/android/auth/` — `auth` feature

Android feature package for **auth**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Auth/`.
