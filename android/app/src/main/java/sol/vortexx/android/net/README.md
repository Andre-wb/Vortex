# `sol/vortexx/android/net/` — `net` feature

Android feature package for **net**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Net/`.
