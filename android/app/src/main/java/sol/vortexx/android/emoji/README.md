# `sol/vortexx/android/emoji/` — `emoji` feature

Android feature package for **emoji**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Emoji/`.
