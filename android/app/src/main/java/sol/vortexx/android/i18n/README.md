# `sol/vortexx/android/i18n/` — `i18n` feature

Android feature package for **i18n**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/I18n/`.
