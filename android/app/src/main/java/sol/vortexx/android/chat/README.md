# `sol/vortexx/android/chat/` — `chat` feature

Android feature package for **chat**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Chat/`.
