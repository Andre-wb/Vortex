# `sol/vortexx/android/bots/` — `bots` feature

Android feature package for **bots**. Internal layout:
...
Mirrors the iOS module of the same name under `../../../../../../../ios/Modules/Sources/Bots/`.
