#!/usr/bin/env python3
"""Генератор кросс-языковых golden-векторов Python ↔ Rust.
...
OUT_PATH = os.path.join(ROOT, "app", "tests", "vectors", "rust_parity.json")

_spec = importlib.util.spec_from_file_location(
    "rust_parity_reference",
    os.path.join(ROOT, "app", "tests", "rust_parity_reference.py"),
)
_reference = importlib.util.module_from_spec(_spec)
sys.modules["rust_parity_reference"] = _reference
