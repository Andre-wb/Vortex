...
DEEP_SUBSYSTEMS["rateLimiting"] = deep(
    ...
    where="`app/security/limits.py` holds the limiter. Auth-route attempts are counted in Rust (`vortex-auth`), reached through `app/authentication/_helpers.py::_allow_login_attempt`.",
    ...
    config=[
        "`LOGIN_ATTEMPTS=10` per 60 s per client address (`vortex_auth::entry::limits`).",
        "`REGISTRATION_ATTEMPTS=5` per 60 s per client address, counted in the same window as logins.",
...
SHORT_DEEP = [
    ...
    "bugBountyProgram",
    "cveAssignment",
    "securityAdvisoryProcess",
    "supplyChainPolicy",
    "dependencyPinning",
    "sbomGeneration",
    "reproducibleBuilds",
    "deterministicArchives",
    "integrityReVerification",
    "codeSigningApple",
    "codeSigningGoogle",
    "codeSigningMicrosoft",
    "appStoreDistribution",
    "playStoreDistribution",
    "fdroidDistribution",
    "alternativeStores",
    "selfHostedDistribution",
    ...
    "dataResidency",
    "dataLocalisationRussia",
    "dataLocalisationChina",
    "dataLocalisationEu",
    "dataLocalisationUs",
    "dataLocalisationIndia",
    "exportControlCompliance",
    "sanctionsCompliance",
    "kycIntegration",
    "amlCompliance",
    "ofacSanctionsCheck",
