...
pub fn challenge_ttl() -> Ttl {
    Ttl::seconds(CHALLENGE_SECONDS).expect("время жизни челленджа кошелька задано ненулевым")
}
...
mod tests {
    ...
    #[test]
    fn the_wallet_challenge_lives_the_five_minutes_the_signature_step_is_given() {
