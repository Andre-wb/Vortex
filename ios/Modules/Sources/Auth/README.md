# `ios/Modules/Sources/Auth/` — Auth

Register, login (password / seed / key / passkey / QR), 2FA, session refresh. Keychain-backed JWT storage.
...
- Tests live in `../../Tests/AuthTests/` (when the suite exists).
