# `ios/Modules/Sources/Chat/` — Chat

Chat screen — composer, renderer, reactions, typing indicator, read receipts, thread panel.
...
- Tests live in `../../Tests/ChatTests/` (when the suite exists).
