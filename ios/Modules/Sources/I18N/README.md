# `ios/Modules/Sources/I18N/` — I18N

Locale loader + Resources/locales/ (146 JSON files matching the web + Android set).
...
- Tests live in `../../Tests/I18NTests/` (when the suite exists).
