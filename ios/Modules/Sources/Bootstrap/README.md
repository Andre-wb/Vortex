# `ios/Modules/Sources/Bootstrap/` — Bootstrap

First-run flow — vortexx.sol SNS probe, manual URL entry, controller pubkey validation, mirror fallback.
...
- Tests live in `../../Tests/BootstrapTests/` (when the suite exists).
