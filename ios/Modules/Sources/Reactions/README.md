# `ios/Modules/Sources/Reactions/` — Reactions

Reaction UI — long-press menu, animated counter, per-message state.
...
- Tests live in `../../Tests/ReactionsTests/` (when the suite exists).
