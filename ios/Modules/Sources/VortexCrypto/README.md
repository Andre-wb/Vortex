# `ios/Modules/Sources/VortexCrypto/` — VortexCrypto

Crypto primitives — X25519, Ed25519, AES-256-GCM, HKDF-SHA256, Argon2id. Thin wrappers around CryptoKit + Argon2Swift. No raw private-key material leaves this module.
...
- Tests live in `../../Tests/VortexCryptoTests/` (when the suite exists).
