# `ios/Modules/Sources/Identity/` — Identity

BIP39 seed handling, identity-key derivation, passphrase strength, Shamir split.
...
- Tests live in `../../Tests/IdentityTests/` (when the suite exists).
