# `ios/Modules/Sources/Scheduled/` — Scheduled

Scheduled sends — upload ciphertext + send-at timestamp, deliver at time.
...
- Tests live in `../../Tests/ScheduledTests/` (when the suite exists).
