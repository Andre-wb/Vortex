# `ios/Modules/Sources/Premium/` — Premium

Subscription state. Reads Solana PDAs directly when the node isn't reachable (censorship fallback).
...
- Tests live in `../../Tests/PremiumTests/` (when the suite exists).
