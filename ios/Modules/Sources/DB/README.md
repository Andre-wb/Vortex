# `ios/Modules/Sources/DB/` — DB

Local persistence via GRDB. Schema + migrations + typed record types for rooms, messages, keys, drafts, etc.
...
- Tests live in `../../Tests/DBTests/` (when the suite exists).
