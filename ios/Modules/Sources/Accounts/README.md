# `ios/Modules/Sources/Accounts/` — Accounts

Multi-account support — switcher, per-account Keychain isolation.
...
- Tests live in `../../Tests/AccountsTests/` (when the suite exists).
