# `ios/Modules/Sources/Calls/` — Calls

WebRTC 1-to-1 + small-group calls. SurfaceView-equivalent renderer via UIViewRepresentable.
...
- Tests live in `../../Tests/CallsTests/` (when the suite exists).
