# `ios/Modules/Sources/Settings/` — Settings

All settings screens — profile, privacy, security, notifications, themes, i18n, backup.
...
- Tests live in `../../Tests/SettingsTests/` (when the suite exists).
