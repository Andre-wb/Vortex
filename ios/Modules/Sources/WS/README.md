# `ios/Modules/Sources/WS/` — WS

URLSessionWebSocketTask wrapper — reconnect, heartbeat, outbound queue, per-topic routing.
...
- Tests live in `../../Tests/WSTests/` (when the suite exists).
