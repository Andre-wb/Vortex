# `ios/Modules/Sources/Net/` — Net

URLSession-based HTTP client + JWT refresh + TLS handling. Everywhere else imports this, not URLSession directly.
...
- Tests live in `../../Tests/NetTests/` (when the suite exists).
