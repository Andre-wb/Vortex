# `ios/Modules/Sources/App/` — App

Composition root. Builds AppEnvironment that wires every other module together and renders the root scene.
...
- Tests live in `../../Tests/AppTests/` (when the suite exists).
