"""Загрузка Rust-реализации Trojan.

Формат запроса, разбор адреса назначения, реестр паролей и решение
«принять / отказать / дочитать» живут в крейте `vortex-transport` и выставлены
...
try:
    from vortex_chat import Trojan
