...
class Space(Base):
    ...
    categories = relationship("SpaceCategory", back_populates="space", cascade="all, delete-orphan")
    rooms = relationship("Room", backref="space", foreign_keys="[Room.space_id]")
...
class SpaceCategory(Base):
    ...
    rooms = relationship("Room", backref="category", foreign_keys="[Room.category_id]")
