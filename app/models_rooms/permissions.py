...
class Permission(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id", ondelete="CASCADE"), nullable=True)  # NULL = role-based
    ...
    __table_args__ = (Index("ix_perm_room", "room_id"),)
...
class AutoModRule(Base):
    ...
    __table_args__ = (Index("ix_automod_room", "room_id"),)
