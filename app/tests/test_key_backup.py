    ...
    def test_get_cross_signs(self, client):
        ...
        client.post(
            ...
            json={
                ...
                "signed_device": 2,
                "signature": sig,
                "signer_pub_hash": signer_hash,
                "signed_pub_hash": signed_hash,
            },
            headers=h,
        )
        ...
        shares = [
            {
                "share_index": 1,
                "encrypted_share": secrets.token_hex(64),
                "recipient_id": recipient["data"]["user_id"],
                "label": "r1",
            },
            {"share_index": 2, "encrypted_share": secrets.token_hex(64), "recipient_id": None, "label": "r2"},
        ]
        client.post(
            "/api/keys/ssss/create",
            json={
...
class TestFederatedBackup:
    ...
    def _mock_push():
        ...
        return patch("app.security.key_backup._push_shard_to_peer", new_callable=AsyncMock, return_value=True)
    ...
    def test_distribute_shards(self, client):
        ...
        with self._mock_push():
            r = client.post(
                "/api/keys/federated-backup/distribute",
                json={
                    "threshold": 2,
                    "total_shards": 3,
    ...
    def test_store_shard_peer_endpoint(self, client):
        ...
        r = client.post(
            "/api/keys/federated-backup/store-shard",
            json={
    ...
    def test_retrieve_shard_peer_endpoint(self, client):
        ...
        r = client.get(
            f"/api/keys/federated-backup/retrieve-shard/{owner_id}",
            headers={
                **h,
    ...
    def test_retrieve_no_shards_404(self, client):
        ...
        r = client.get(
            f"/api/keys/federated-backup/retrieve-shard/{own_id}",
            headers={
                **h,
