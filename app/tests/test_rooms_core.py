...
from conftest import SyncASGIClient, _phone_prefix, login_user, make_user, random_str
    ...
    def test_create_room_unauthenticated(self, client: SyncASGIClient):
        ...
        resp = bare.post(
            ...
            json={
                "room_name": "HackRoom",
                "is_public": True,
                "encrypted_room_key": {"key": secrets.token_hex(32), "iv": secrets.token_hex(16), "version": "1"},
