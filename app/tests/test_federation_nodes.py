...
class TestFederationNodes:
    ...
    def test_add_node_duplicate(self, client: SyncASGIClient, logged_user: dict):
        ...
        client.post(
            ...
            headers={**logged_user["headers"], "X-Federation-Proof": make_federation_proof(nid)},
        )
    ...
    def test_validate_token_invalid(self, client: SyncASGIClient, logged_user: dict):
        ...
        r = client.post(
            ...
            headers={**logged_user["headers"], "X-Federation-Proof": make_federation_proof("nonexistent-node-id")},
        )
        assert r.status_code == 200
        body = r.json()
